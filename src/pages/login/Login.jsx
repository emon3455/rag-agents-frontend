    ...
    return (
        <>
            <div className="absolute top-5 left-5 text-white z-20">
                <Link to="/" className="text-orange-500 text-2xl"><FaHome /></Link>
            </div>
            <section className="flex flex-col lg:flex-row min-h-screen">

                <div className="hidden lg:flex bg-black min-h-screen w-full lg:w-1/2  justify-center items-center relative">
                    <div className="w-full lg:w-3/5">
                        <img src="https://img.freepik.com/premium-photo/white-robot-sits-front-computer-screen_1104726-14675.jpg?w=740" alt="login image" className="w-96 rounded" />
                    </div>
                </div>
                ...
                <div className="bg-gray-200 min-h-screen w-full lg:w-1/2 mx-auto grid grid-cols-1 items-center p-2">
                    <div className="border rounded border-white p-4 w-4/5 mx-auto">
                        <form onSubmit={handleSubmit} className="card-body ">
                            <h2 className="text-xl lg:text-xl font-bold text-center">Welcome To <span className="text-orange-500">ODL</span> AI</h2>
                            ...
                            <div className="mt-2">
                                <CButton variant={"outline"} type={"submit"} loading={isLoading}>Login</CButton>
                            </div>
